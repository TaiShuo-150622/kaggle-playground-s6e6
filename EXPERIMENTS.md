...
| CatBoost | 0.95728 | **0.96500** | — | ✅ **0.96642** |
| FT-Transformer | 0.95981 | **0.96200** | 0.00219 | ⬜ |
| LightGBM (best) | 0.95864 | **0.96500** | 0.00636 | ⬜ 252特征仅+0.00032 |
| XGBoost (best) | 0.95637 | **0.96500** | 0.00863 | ⬜ 252特征仅+0.00007 |
| XGBoost OVR | — | **0.96500** | — | ⚠️ 概率校准bug |
...
|---|------|------|------|------|-----------|----------|---|------|
| 1 | 6/23 | 特征工程 V3 | 252特征+社区参数 → 树模型 | CB | 0.95728 | **0.96642** | **+0.00914** | ✅ 达标 |
| 2 | 6/23 | 特征工程 V3 | 252特征 → LGB | LGB | 0.95864 | 0.95896 | +0.00032 | ⬜ 未达标 |
| 3 | 6/23 | 特征工程 V3 | 252特征+GPU → XGB | XGB | 0.95637 | 0.95644 | +0.00007 | ⬜ 未达标 |
| 4 | 6/23 | One-vs-Rest | 3×二分类XGB | XGB-OVR | — | 0.95377 | — | ⚠️ 概率校准问题 |
